...
public class Edge1 {
    ...
    public static final String Name_EDGE = "EDGE1";
    ...
    public static final String ChildPeerGroupName = "MonGroupe";
    public static final PeerGroupID ChildPeerGgroupID = IDFactory.newPeerGroupID(PeerGroupID.defaultNetPeerGroupID, ChildPeerGroupName.getBytes());
