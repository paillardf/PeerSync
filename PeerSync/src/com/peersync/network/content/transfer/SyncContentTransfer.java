 ...
 *
 */
public class SyncContentTransfer extends AbstractContentTransfer
        implements PipeMsgListener {
    /**
     * Logger instance.
     */
    private static final Logger LOG =
            Logger.getLogger(SyncContentTransfer.class.getName());

    /**
     * The number of seconds between source discovery attempts.
     */
    private static final int SOURCE_LOCATION_INTERVAL =
            Integer.getInteger(SyncContentTransfer.class.getName()
    ...
    private static final long PIPE_TIMEOUT =
            Long.getLong(SyncContentTransfer.class.getName()
    ...
    private static final boolean SIMULATE_PACKET_LOSS =
            Boolean.getBoolean(SyncContentTransfer.class.getName()
            + ".simulatePacketLoss");
