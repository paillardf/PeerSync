 ...
 */
public abstract class AbstractFolderTransfer
     ...
     */
    protected final Object lockObject = this;
     ...
     * from.
     */
    protected List<ContentShareAdvertisement> allSources =
     ...
     */
    protected List<ContentShareAdvertisement> newSources =
   ...
   /**
     ...
     */
    protected AbstractFolderTransfer(
        ...
        LOG = Logger.getLogger(
        		AbstractFolderTransfer.class.getName() + "-" + loggerID);
    }
    ...
    private void transferExecution() throws InterruptedException {
        ...
        try {
            do {
                ...
                if (allSources.size() + newSources.size() == 0) {
